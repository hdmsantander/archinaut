...
public class Delta {
	...
	/**
	 * 
	 * Create a Delta between two elements. If diffType is DIFFTARGET_OLDER,
	 * the target element is from a previous version, if it is DIFFTARGET_NEWER
	 * it is from a more recent version.
	 * 
	 * @param original
